...
hold on 
plot(frequency_range/1e6,skin_depth_max*1e3,linewidth = 2,Color='black',LineStyle='--')
fill([frequency_range/1e6, fliplr(frequency_range/1e6)], [skin_depth_min*1e3, fliplr(skin_depth_max*1e3)], ...
    'k', 'FaceAlpha', 0.2, 'EdgeColor', 'none');

plot(frequency_range/1e6,skin_depth_mean*1e3,linewidth = 3,Color='red')

xlim([1,100])
legend({'Min','Max','Variation Interval','Average'},fontsize = 14,interpreter = 'latex')
